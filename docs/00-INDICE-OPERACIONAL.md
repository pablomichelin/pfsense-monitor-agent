...
> **Versoes atuais (codigo):** API `0.11.0` · painel `1.12.1` · package pfSense `0.5.14` (publicar com `scripts/release-pfsense-package.sh`).
>
> **Ultima entrega (2026-08-23):** hotfix modal Apontar branch (painel `1.12.1`). Ver `docs/175-ENTREGA-FIRMWARE-BRANCH-UPDATE-PFSENSE-2026-08-23.md`.
>
