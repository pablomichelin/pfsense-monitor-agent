...
> **Versoes atuais (codigo):** API `0.11.0` · painel `1.12.2` · package pfSense `0.5.15` (publicar com `scripts/release-pfsense-package.sh`).
>
> **Ultima entrega (2026-08-23):** hotfix helper firmware branch (package `0.5.15`, painel `1.12.2`). Ver `docs/176-HOTFIX-HELPER-FIRMWARE-BRANCH-0.5.15-2026-08-23.md`.
>
