...
- `2026-03-15`: Validação do pfSense real Lasalle Agro (lado painel). Ver `docs/40-VALIDACAO-PFSENSE-REAL-LASALLE-AGRO-2026-03-15.md`. Node online, agent 0.2.0, heartbeat recente, alertas resolvidos, degraded resolvido. Reinstalação não necessária com base nos dados do painel. Checklist para validação manual no pfSense documentado.
